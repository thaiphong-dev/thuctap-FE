...
export default function Shop() {
    ...
    const { filterProducts } = useSelector(state => state.ProductReducer || null);
    ...
    useEffect( () => {
        const filter = async () => {
            await ProductsApi.getProductType().then((data) => {
                dispatch({
                            ...
                            <div className="bg-light p-4 mb-30">
                                <form >
                                    <div className="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                                        <input type="radio" name='Cate' className="custom-control-input" defaultChecked id="cate-all" value={0} onChange={handlechange} />
