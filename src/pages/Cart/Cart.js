                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td className="form-group">
                                                    <select onChange={(e) => handleChange(cart.id, e)} className="form-control">
                                                ...
                                                <td className="align-middle">{(cart?.gia * cart?.number)}</td>
                        ...
                        <div className="col-lg-4">
                            <form className="mb-30">
                                <div className="input-group">
                                    ...
                                    <div className="input-group-append">
                                        <button className="btn btn-primary">Nhập mã khuyễn mãi</button>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div className="bg-light p-30 mb-5">
                                ...
                                <div className="pt-2">
                                    ...
                                    <button onClick={() => handleClick()} className="btn btn-block btn-primary font-weight-bold my-3 py-3">Thanh toán</button>
                                </div>
                            </div>
                        </div>
                    </div>
