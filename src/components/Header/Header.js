    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            const findProduct = async () => {
                ...
                const payload = {tenSP: values.tenSP.replace(/\s+/g,' ').trim()}
                await ProductsApi.filterProductbyName(payload)
                .then((values) => {
                    dispatch({
                        type: "FILTER_PRODUCT",
                        product: values.data
                    ...
                    <div className="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
                        <div className="col-lg-4">
                            <NavLink to='/' className="text-decoration-none">
                                <span className="h1 text-uppercase text-primary bg-dark px-2">Clothing</span>
                        ...
                        <div className="col-lg-4 col-6 text-left">
                            <form onSubmit={(e) => {
                                ...
                                <div className="input-group">
                                    <input  onChange={formik.handleChange} type="text" className="form-control" placeholder="Tìm kiếm sản phẩm" name='tenSP' id="tenSP" />
                        ...
                        <div className="col-lg-9">
                            <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                                <a href='#' className="text-decoration-none d-block d-lg-none">
                                    <span className="h1 text-uppercase text-dark bg-light px-2">Clothing</span>
