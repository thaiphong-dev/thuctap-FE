...
export default function Product() {
    ...
    useEffect(() => {
        getAllProduct();
        getAllCategory();
    }, [listProduct?.length, statusProduct, infoProduct])
                    ...
                    <form onSubmit={formik.handleSubmit} style={{ color: "black", fontSize: "18px" }}>
                        <Row>
                            ...
                            <Col>
                                ...
                                <Form.Control required name="hinhAnh" onChange={formik.handleChange} />
                            </Col>
                            <Col>
                        ...
                        {({
                            ...
                            <Form onSubmit={handleSubmit} style={{ color: "black", fontSize: "18px" }}>
                                <Row>
                                    ...
                                    <Col>
                                        <Form.Label>Hình Ảnh</Form.Label>
                                        <Form.Control required name="hinhAnh" onChange={handleChange} value={values.hinhAnh} />
                                    </Col>
                                    <Col>
                                        <Form.Label>Thể Loại</Form.Label>
